...
<div class="main-div" id="conent_area">
	<?php endif; ?>
	<form method="post" name="theForm" action="mail_template.php?act=save_template">
		<table id="general-table" align="center">
			<tr>
				<td style="font-weight: bold;" width="25%" align="right"><?php echo $this->_var['lang']['select_template']; ?></td>
				<td>
			...
			<tr>
				<td style="font-weight: bold;" width="25%" align="right"><?php echo $this->_var['lang']['mail_subject']; ?>:</td>
				<td>
					<input type="text" name="subject" id="subject" style="width: 300px" value="<?php echo $this->_var['template']['template_subject']; ?>" />
				</td>
			</tr>
			<tr>
				<td style="font-weight: bold" align="right"><?php echo $this->_var['lang']['mail_type']; ?>:</td>
				<td>
			...
			<tr>
				<td colspan="2">
					<?php if ($this->_var['template']['is_html'] == '1'): ?><div style="width: 70%;margin:20px auto;" ><?php echo $this->_var['FCKeditor']; ?></div><?php else: ?>
					<textarea name="content" id="content"rows="16"><?php echo $this->_var['template']['template_content']; ?></textarea>
					<?php endif; ?>
				</td>
			</tr>
            <style type="text/css">
			#xEditingArea{border:none}
			</style>
			<tr>
