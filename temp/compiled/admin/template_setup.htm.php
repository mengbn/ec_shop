...
<link href="js/jPicker/css/jPicker-1.1.6.min.css" rel="stylesheet" type="text/css" />
<link href="js/jPicker/jPicker.css" rel="stylesheet" type="text/css" />
<?php echo $this->smarty_insert_scripts(array('files'=>'jquery.ztree.all-3.5.min.js,category_selecter.js,jPicker/jpicker-1.1.6.js')); ?>
<div class="form-div">
...
?>
  <tr class="tr_cate_goods">
	...
	分类：<input type="text" id="cat_name_<?php echo ($this->_foreach['cat']['iteration'] - 1); ?>" class="cat_name" nowvalue="<?php echo $this->_var['library']['cat_id']; ?>" value="" ><!--代码增加--商品分类--68ecshop-->
	...
	简称：<input type="text" id="ext_info[short_name][]" name="ext_info[short_name][]" value="<?php echo $this->_var['library']['ext_info']['short_name']; ?>" style="width: 50px" class="cat_short_name" />
	颜色：<input type="text" id="ext_info[cat_color][]" name="ext_info[cat_color][]" value="<?php echo $this->_var['library']['ext_info']['cat_color']; ?>" style="width: 60px" class="cat_color" />
    </td>
...
function addCatGoods(obj)
{
    ...
    var row  = table.insertRow(rowId + 1 + $(".tr_cate_goods").size());
    row.className = "tr_cate_goods";
	...
	cell.innerHTML = '分类：<input type="text" id="cat_name' + index + '" nowvalue="<?php echo $this->_var['goods_cat_name']; ?>" value="<?php echo $this->_var['goods_cat_name']; ?>" class="cat_name" >'
					+'<input type="hidden" id="cat_id' + index + '" name="categories[cat_goods][]" value="<?php echo $this->_var['goods_cat_id']; ?>" class="cat_id" >';
    
	cell.innerHTML += '&nbsp;简称：<input type="text" id="ext_info[short_name][]" name="ext_info[short_name][]" value="" style="width: 50px" class="cat_short_name" >';
	cell.innerHTML += '&nbsp;颜色：<input type="text" id="cat_color_'+index+'" name="ext_info[cat_color][]" value="" style="width: 60px" class="cat_color" >';
...
//-->
$().ready(function(){
	var jPickers = $(".cat_color").jPicker();
	//$(".cat_color").hide();
});
</script>
