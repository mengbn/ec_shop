...
?>
        <li> <a href="<?php echo $this->_var['picture']['img_original']; ?>" rel="zoom-id: zoom;" rev="<?php echo $this->_var['picture']['img_url']; ?>"   title="<?php echo htmlspecialchars($this->_var['picture']['img_desc']); ?>" <?php if ($this->_foreach['pictures']['iteration'] == 1): ?>class="gallery_img_cur"<?php endif; ?>> <img src="<?php if ($this->_var['picture']['thumb_url']): ?><?php echo $this->_var['picture']['thumb_url']; ?><?php else: ?><?php echo $this->_var['picture']['img_url']; ?><?php endif; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>" class="B_blue"  /> </a> </li>
