...
<dl class="commente-info clearfix">
  <dt>
    <div><img src="<?php if ($this->_var['value']['headimg'] == ''): ?>themes/68ecshopcom_360buy/images/people.gif<?php else: ?><?php echo $this->_var['value']['headimg']; ?><?php endif; ?>" height="80" width="80" /></div>
